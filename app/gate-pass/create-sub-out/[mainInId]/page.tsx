...
import CreateSubOutClient from "./CreateSubOutClient";

export default async function CreateSubOutPage({ params }: { params: Promise<{ mainInId: string }> }) {
  ...
  return <CreateSubOutClient mainIn={mainIn} user={session.user} />;
}
