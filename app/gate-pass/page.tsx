    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <div className="flex gap-2 mb-4">
        {([
          ...
          <button key={key} onClick={() => setPassTypeFilter(key)} suppressHydrationWarning
      ...
      <div className="rounded-2xl border overflow-hidden" style={{ background: "var(--surface)", borderColor: "var(--border)" }}>
        ...
        <div className="flex items-center gap-3 p-4 border-b flex-wrap" style={{ borderColor: "var(--border)" }}>
          ...
          <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} suppressHydrationWarning
